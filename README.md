...
To install CPSA, follow the instructions in the CPSA installation instructions file, linked [here](CPSA-workshops/CPSA_INSTALL.md).
...
We then discuss a common solution for executing the meeting protocol, [Needham-Schroeder](CPSA-workshops/needham-schroeder/ns.scm).
...
We add the Lowe fix [here](CPSA-workshops/needham-schroeder/ns-fix.scm).
